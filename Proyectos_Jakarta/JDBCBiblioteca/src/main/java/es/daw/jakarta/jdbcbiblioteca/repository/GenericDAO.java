...
public interface GenericDAO<T, ID> {
    ...
    List<T> findByAutor(ID id_autor) throws SQLException;

    List<T> findByFecha(Date fechaInicio, Date fechaFin) throws SQLException;

    // Pendiente Puedo crear un metodo como findByName
