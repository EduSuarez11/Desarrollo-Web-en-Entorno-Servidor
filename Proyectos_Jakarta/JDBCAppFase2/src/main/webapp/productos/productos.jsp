...
<%@ page import="es.daw.jakarta.jdbcappfase2.model.Producto" %>
<%@ page import="es.daw.jakarta.jdbcappfase2.model.Fabricante" %>
<%@ page import="es.daw.jakarta.jdbcappfase2.util.Utils" %>
