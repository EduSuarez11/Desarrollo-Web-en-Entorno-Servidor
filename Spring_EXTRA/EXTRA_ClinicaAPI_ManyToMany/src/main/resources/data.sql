...
-- PATIENTS (30)
-- -------------------------
INSERT INTO patients (dni, full_name, email, phone, date_of_birth, has_insurance, active) VALUES
                                                                               ('111A','Ana García','ana@demo.com','600111111','1990-01-10', false, true),
                                                                               ('222B','Luis Pérez','luis@demo.com','600222222','1985-07-21', true, true),
                                                                               ('333C','María Sánchez','maria@demo.com','600333333','1992-03-05', false, true),
                                                                               ('444D','Carlos Gómez','carlos@demo.com','600444444','1980-11-12', false, true),
                                                                               ('555E','Lucía Fernández','lucia@demo.com','600555555','1995-06-18', false, true),
                                                                               ('666F','Javier Martín','javier@demo.com','600666666','1978-09-30', true, true),
                                                                               ('777G','Paula Romero','paula@demo.com','600777777','1989-12-02', false, true),
                                                                               ('888H','Sergio Navarro','sergio@demo.com','600888888','1991-04-27', true, true),
                                                                               ('999I','Elena Ortega','elena@demo.com','600999999','1987-08-14', false, true),
                                                                               ('101J','David Torres','david@demo.com','601010101','1993-02-09', true, true),
                                                                               ('102K','Carmen Molina','carmen@demo.com','601020202','1975-05-23', true, true),
                                                                               ('103L','Alberto Ruiz','alberto@demo.com','601030303','1982-10-07', false, true),
                                                                               ('104M','Irene Delgado','irene@demo.com','601040404','1997-01-19', false, true),
                                                                               ('105N','Raúl Castillo','raul@demo.com','601050505','1984-07-28', true, true),
                                                                               ('106O','Sara Iglesias','sara@demo.com','601060606','1990-09-11', true, true),
                                                                               ('107P','Hugo Vidal','hugo@demo.com','601070707','1988-12-25', false, true),
                                                                               ('108Q','Nerea Campos','nerea@demo.com','601080808','1994-04-03', true, true),
                                                                               ('109R','Óscar Herrera','oscar@demo.com','601090909','1979-06-16', false, true),
                                                                               ('110S','Marta León','marta.leon@demo.com','602000001','1996-08-08', false, true),
                                                                               ('111T','Iván Flores','ivan@demo.com','602000002','1983-03-31', true, true),
                                                                               ('112U','Andrea Reyes','andrea@demo.com','602000003','1991-11-05', false, true),
                                                                               ('113V','Pedro Ramos','pedro@demo.com','602000004','1977-02-20', false, true),
                                                                               ('114W','Noelia Gil','noelia@demo.com','602000005','1986-09-09', true, true),
                                                                               ('115X','Daniel Suárez','daniel@demo.com','602000006','1998-05-14', false, true),
                                                                               ('116Y','Patricia Núñez','patri@demo.com','602000007','1992-07-01', true, true),
                                                                               ('117Z','Adrián Cabrera','adrian@demo.com','602000008','1981-01-26', false, true),
                                                                               ('118AA','Claudia Peña','claudia@demo.com','602000009','1990-10-10', false, true),
                                                                               ('119AB','Fernando Mora','fernando@demo.com','602000010','1976-12-12', false, true),
                                                                               ('120AC','Beatriz Soto','bea@demo.com','602000011','1989-02-02', false, true),
                                                                               ('121AD','Álvaro Prieto','alvaro@demo.com','602000012','1993-06-06', false, false); -- inactivo para filtros
...
-- MEDICAL SERVICES (6)
-- -------------------------
INSERT INTO medical_services (code, name, base_price, vat_rate, active) VALUES
                                                                  ('CONS-GEN','Consulta general', 50.00, 'VAT_21', true),
                                                                  ('DERM-REV','Revisión dermatológica', 80.00, 'VAT_10', true),
                                                                  ('CARD-ECG','ECG / Cardiología', 120.00 ,'VAT_10', true),
                                                                  ('PED-CONT','Control pediatría', 45.00, 'VAT_0', true),
                                                                  ('VAC-FLU','Vacuna gripe', 25.00, 'VAT_21',true),
                                                                  ('NUTRI-PLAN','Plan nutrición', 60.00, 'VAT_0', true);
